    ...
    def call_postgres(
        ...
        *,
        ...
        league_data = riot_api.get_league_by_queue_tier_division(
            queue=message.queue, tier=message.tier, division=message.division
        )
        for summoner_league in league_data:
            ...
            for summoner_matchid in summoner_matchids:
                ...
                match_id = summoner_match["metadata"][
                    "matchId"
                ...
                game_start_timestamp = datetime(1970, 1, 1, 0, 0, 0) + timedelta(
                    milliseconds=summoner_match["info"]["gameStartTimestamp"]
                )
                game_end_timestamp = datetime(1970, 1, 1, 0, 0, 0) + timedelta(
                    milliseconds=summoner_match["info"]["gameEndTimestamp"]
                )
                ...
                query = postgres.create_insert_query(
                    ...
                    columns=[
                        ...
                        "summoner_spell1_id",
                        "summoner_spell2_id",
                        "summoner_spell1_casts",
                        "summoner_spell2_casts",
                        "kills",
                        "deaths",
                        "assists",
                        "longest_time_living",
